...
class ControllerModuleJournal2 extends Controller {
    ...
    public function index() {
        $this->document->setTitle('Панель управления Journal2');

        $this->document->addStyle('//fonts.googleapis.com/css?family=Cuprum');
    ...
    public function clear_cache() {
        if ($this->user->hasPermission('modify', 'module/journal2')) {
            ...
            $this->session->data['success'] = 'Кеш шаблона успешно очищен.';
        } else {
            $this->session->data['warning'] = 'У Вас нет прав на изменение шаблона.';
        }
