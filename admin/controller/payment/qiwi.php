...
class ControllerPaymentQiwi extends Controller {
	...
	$this->document->setTitle = $this->language->get('heading_title');
		...
		$this->data['entry_rub_select'] = $this->language->get('entry_rub_select');

		$this->data['entry_markup'] = $this->language->get('entry_markup');

		$this->data['entry_qiwi_mode'] = $this->language->get('entry_qiwi_mode');


		$this->data['entry_qiwi_modes'][] = array('code'=>'qiwi_mode_normal', 'code_text'=>$this->language->get('entry_qiwi_mode_normal'));
		$this->data['entry_qiwi_modes'][] = array('code'=>'qiwi_mode_debug', 'code_text'=>$this->language->get('entry_qiwi_mode_debug'));
		...
		if (isset($this->request->post['qiwi_rub_select'])) {
			$this->data['qiwi_rub_select'] = $this->request->post['qiwi_rub_select'];
		} elseif( $this->config->get('qiwi_rub_select') ) {
			$this->data['qiwi_rub_select'] = $this->config->get('qiwi_rub_select');
		} else {
			$this->data['qiwi_rub_select'] = 'RUB';
		}
		...
		if (isset($this->request->post['qiwi_mode_select'])) {
			$this->data['qiwi_mode_select'] = $this->request->post['qiwi_mode_select'];
		} else {
			$this->data['qiwi_mode_select'] = $this->config->get('qiwi_mode_select');
		}
