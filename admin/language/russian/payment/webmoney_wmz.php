...
$_['text_webmoney_wmz'] 		= '<a onclick="window.open(\'http://webmoney.ru\');"><img src="/image/payment/wmz.png" alt="Webmoney" title="Webmoney" style="border: 1px solid #EEEEEE;" height="25px" /></a>';
...
$_['error_merch_z']        	= 'Неверный номер кошелька!';
