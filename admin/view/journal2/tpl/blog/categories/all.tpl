               ...
               <accordion-heading>
                   <div class="accordion-bar bar-level-0 bar-pt">
                       ...
                       <span class="module-options">
                            <a href="<?php echo $base_href;?>#/blog/categories/form/{{category.category_id}}" data-ng-click="$event.stopPropagation()" class="accordion-remove edit-module"><b></b>Изменить</a>
                       </span>
                   </div>
               </accordion-heading>
           </accordion-group>
