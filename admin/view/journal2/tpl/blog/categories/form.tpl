...
<div class="module-header">
   <div class='module-name'>Категории<span data-ng-show="category_id == null">Создание Категории</span><span data-ng-show="category_id != null">Изменение Категории</span></div>
   <div class="module-buttons">
       <a href="<?php echo $base_href;?>#/blog/categories" class="btn blue">Назад</a>
       <a data-ng-click="save($event)" class="btn green">Сохранить</a>
       <a data-ng-click="delete($event)" data-ng-show="category_id != null" class="btn red">Удалить</a>
   </div>
</div>
</div>
       ...
       <accordion-group is-open="accordion.layouts_is_open">
           ...
           <ul class="module-create-options">
               <li data-ng-repeat="store in stores">
                   ...
                   <span class="module-create-option">
                       <select class="journal-select" data-ng-model="category_data.layouts['s_' + store.store_id]" ui-select2="{width: 400, minimumResultsForSearch: -1, placeholder: 'Выберите Макет'}" required>
                           <option value="">&nbsp;</option>
