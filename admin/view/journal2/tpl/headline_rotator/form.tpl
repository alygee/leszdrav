...
<div class="module-header">
   <div class='module-name'>Ротатор Заголовков<span data-ng-show="module_id == null">Создание Модуля</span><span data-ng-show="module_id != null">Изменение Модуля</span></div>
...
<div class="module-body module-form">
   ...
   <accordion close-others="module_data.close_others">
       ...
       <accordion-group data-ng-repeat="section in module_data.sections" is-open="section.is_open">
           ...
           <ul class="module-create-options">
               <li>
                   <span class="module-create-title">Название Элемента</span>
                   <span class="module-create-option">
                       <input type="text" class="journal-input" data-ng-model="section.name" />
                   </span>
               </li>
               <li>
                   <span class="module-create-title">Текст Ротатора</span>
                   <span class="module-create-option">
               ...
               <li>
                   <span class="module-create-title">Кнопка Призыва к Действию</span>
                   <span class="module-create-option">
               ...
               <li data-ng-show="section.cta == '1'">
                   <span class="module-create-title">Позиция Кнопки</span>
                   <span class="module-create-option">
               ...
               <li data-ng-show="section.cta == '1'">
                   ...
                   <span class="module-create-option">
                       <input type="text" class="journal-input journal-number-field" data-ng-model="section.cta_offset_top" placeholder="Верх"/> &nbsp;
                       <input type="text" class="journal-input journal-number-field" data-ng-model="section.cta_offset_left" placeholder="Лево"/>
                   </span>
               </li>
