...
<div class="module-header">
   <div class='module-name'>Баннеры<span data-ng-show="module_id == null">Создание Модуля</span><span data-ng-show="module_id != null">Изменение Модуля</span></div>
...
<div class="module-body module-form">
   ...
   <accordion close-others="module_data.close_others">
       <accordion-group is-open="module_data.general_is_open">
           ...
           <ul class="module-create-options">
               ...
               <li>
                   <span class="module-create-title">Иконка Наложения</span>
                   <span class="module-create-option">
                       <icon-select data-ng-model="module_data.icon"></icon-select>
                   </span>
               </li>
               <li>
                   <span class="module-create-title">Цвет Наложения</span>
                   <span class="module-create-option">
       ...
       <accordion-group data-ng-repeat="section in module_data.sections" is-open="section.is_open">
           <accordion-heading>
               <div class="accordion-bar bar-level-1"> {{'Баннер ' + ($index + 1)}}<a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeSection($index)"><b ></b>Удалить</a></div>
           </accordion-heading>
           <ul class="module-create-options">
               <li>
   ...
   <div class="add-level add-level-1" data-ng-click="addSection()">Добавить Баннер +</div>
</div>