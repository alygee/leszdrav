...
<div class="tab-content">
	...
	<div class="tab-pane" id="tab-style">
		<table class="form">
			<tr>
				<td><?php echo $entry_color_counter_background; ?></td>
				<td>
					<input class="colorPicker" type="input" name="<?php echo $_name; ?>_settings[background_color_counter]" value="<?php echo ! empty( $settings['background_color_counter'] ) ? $settings['background_color_counter'] : '#428bca'; ?>" />
					
					<img src="<?php echo $HTTP_URL; ?>view/stylesheet/mf/images/couter-color.png" />
				</td>
			</tr>
			<tr>
				<td><?php echo $entry_color_counter_text; ?></td>
				<td>
					<input class="colorPicker" type="input" name="<?php echo $_name; ?>_settings[text_color_counter]" value="<?php echo ! empty( $settings['text_color_counter'] ) ? $settings['text_color_counter'] : '#ffffff'; ?>" />
			...
			<tr>
				...
				<td>
					<input class="colorPicker" type="input" name="<?php echo $_name; ?>_settings[background_color_search_button]" value="<?php echo ! empty( $settings['background_color_search_button'] ) ? $settings['background_color_search_button'] : '#428bca'; ?>" />
			...
			<tr>
				...
				<td>
					<input class="colorPicker" type="input" name="<?php echo $_name; ?>_settings[background_color_slider]" value="<?php echo ! empty( $settings['background_color_slider'] ) ? $settings['background_color_slider'] : ''; ?>" />
	...
	<div class="tab-pane" id="tab-other">
		<table class="form">
			...
			<tr>
				<td><?php echo $entry_javascript; ?></td>
				<td>
<?php
...
";
					...
					?>
					<textarea name="<?php echo $_name; ?>_settings[javascript]" cols="150" rows="10"><?php echo empty( $settings['javascript'] ) ? $javascript_example_code : $settings['javascript']; ?></textarea>
				</td>
			</tr>
			<tr>
				...
				<td>
					<table>
						<tr>
							<td>
								<input type="text" name="<?php echo $_name; ?>_settings[content_selector]" value="<?php echo ! empty( $settings['content_selector'] ) ? $settings['content_selector'] : '#content'; ?>" />
							</td>
							<td>
