...
<?php } ?>
        ...
        <tr>
          <td><?php echo $entry_rub_select; ?></td>
          <td><select name="qiwi_rub_select">
              <?php foreach ($currencies as $currency) { ?>
              <?php if ($currency['code'] == $qiwi_rub_select) { ?>
        ...
        <tr>
          <td><?php echo $entry_qiwi_mode; ?></td>
          <td>

<select name="qiwi_mode_select">
              <?php foreach ($entry_qiwi_modes as $mode) { ?>
              <?php if ($mode['code'] == $qiwi_mode_select) { ?>
