        	...
        	<tr class="non_reset">
        		...
        		<td>
        			<select name="delete_diff" onchange="updateText();">
        				...
        				<option value="delete" <?php if (isset($delete_diff) && $delete_diff == 'delete') echo 'selected="true"'; ?>>Delete</option>
        				<option value="disable" <?php if (isset($delete_diff) && $delete_diff == 'disable') echo 'selected="true"'; ?>>Disable</option>
        			</select>
        		</td>
        	</tr>
        	<!-- Identify Existing Items -->
        	<tr class="non_reset">
        		<td>Identify Existing Products by Matching Field:</td>
        		<td>       	
