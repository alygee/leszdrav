...
class ControllerPaymentWebmoneyWMZ extends Controller {
	...
	$this->data['button_confirm'] = $this->language->get('button_confirm');
		...
		// Переменные
		$this->data['LMI_PAYEE_PURSE'] = $this->config->get('webmoney_wmz_merch_z');  // LMI_PAYEE_PURSE Номер кошелька
	...
	public function callback() {
		...
		$crc = strtoupper(sha256($LMI_PAYEE_PURSE . $LMI_PAYMENT_AMOUNT . $LMI_PAYMENT_NO . $LMI_MODE . $LMI_SYS_INVS_NO . $LMI_SYS_TRANS_NO . $LMI_SYS_TRANS_DATE . $LMI_SECRET_KEY . $LMI_PAYER_PURSE . $LMI_PAYER_WM));
