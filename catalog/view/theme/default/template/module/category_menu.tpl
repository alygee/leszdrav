<div class="box">
  ...
  <div class="box-content">
    <ul class="<?php echo $style; ?>-category <?php echo $position; ?>">
      ...
      <li class="category-<?php echo $category['category_id']; ?> active">
...
<div class="menu_img">
 <?php if ($category['thumb'] && $image && $category['menu_image']) { ?>
      ...
      <a href="<?php echo $category['href']; ?>" class="category-<?php echo $toggle; ?> active">
      ...
      <?php echo $category['name']; ?></a>
        <?php } else { ?>
      <li class="category-<?php echo $category['category_id']; ?>">
<div class="menu_img">
  <?php if ($category['thumb'] && $image && $category['menu_image']) { ?>
          <img src="<?php echo $category['thumb']; ?>" alt="<?php echo $category['name']; ?>">
          <?php } ?>
      ...
      <a href="<?php echo $category['href']; ?>" class="category-<?php echo $toggle; ?>">
