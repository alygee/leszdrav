...
?>
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>" class="<?php echo $this->journal2->html_classes->getAll(); ?>">
<head>
<meta charset="UTF-8" />
...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/journal2/css/starhome.css"/>
