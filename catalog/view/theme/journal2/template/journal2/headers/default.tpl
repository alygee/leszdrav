<header class="journal-header-default">
    ...
    <div id="header" class="journal-header">
        ...
        <div class="journal-links j-min xs-100 sm-100 md-66 lg-50 xl-75">
   ...
   <div class="row journal-login j-min xs-100 sm-100 md-66 lg-50 xl-25">
            ...
            <div class="cont">
                ...
                <div class="callme_viewform"></div>
            </div>
          </div>
        </div>

 <?php if (!Journal2Cache::$mobile_detect->isMobile() || !$this->journal2->settings->get('responsive_design')): ?>
        <div class="journal-cart j-min xs-100 sm-100 md-33 lg-25 xl-20">
            <?php echo $cart; ?>
        </div>
        <?php endif; ?>
