<header class="journal-header-center journal-header-mega nolang-nocurr">
    ...
    <div id="header" class="journal-header row z-2">
        ...
        <div class="journal-logo j-100 xs-100 sm-100 md-35 lg-30 xl-30">
            <?php if ($logo) { ?>
            <div id="logo">
        ...
        <div class="journal-search j-min xs-100 sm-100 md-60 lg-25 xl-25">
            <?php if (Front::$IS_OC2): ?>
            <?php echo $search; ?>
            <?php else: ?>
        ...
        <div class="journal-search j-min xs-100 sm-50 md-45 lg-45 xl-35">
            <?php if (Front::$IS_OC2): ?>
            <?php echo $search; ?>
            <?php else: ?>
            <div id="search" class="j-min">
 ...
 <div class="cont j-80 xs-100 sm-55 md-35 lg-25 xl-25">
              <div class="phone">
                    8-800-301-2822
                </div>
                <div class="callme_viewform">Обратный звонок</div>
        ...
        <div class="journal-cart row j-min xs-100 sm-45 md-30 lg-20 xl-20">
            <?php echo $cart; ?>
        </div>
