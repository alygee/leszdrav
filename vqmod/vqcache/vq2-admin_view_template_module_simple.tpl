...
function selectbox_html($name, $value, $fields, $type='hidden', $help = '') {
    ...
    global $text_select;
    global $text_drag_n_drop;

    $n = md5($name);
    $html = '<span class="help">'.$text_drag_n_drop.'</span>';
    ...
    foreach ($fields as $key => $text) {
        ...
        $html .= '<option '.$style.' value="'.$key.'">'.str_replace('\'', '"',$text).'</option>';
    }
    $html .= '</select>';
...
<div class="box">
  ...
  <div class="content">
    <div id="tabs" class="htabs">
        ...
        <a href="#tab-template"><?php echo $tab_template_helper ?></a>
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div id="tab-checkout">
        ...
        <table class="form">
          <tr>
            ...
            <td><textarea name="simple_common_template" cols="150" rows="5"><?php echo $simple_common_template ?></textarea>
              ...
              <?php } ?>
                <div class="help"><?php echo $text_examples ?>:</div>
                <br>
                <div class="help"><?php echo $text_example_two_columns ?>:</div>
                ...
                <br>
                <div class="help"><?php echo $text_example_one_column ?>:</div>
                <div class="help">{help}{customer}{shipping}{payment}{cart}{agreement}{payment_form}</div>
                <br>
                <div class="help"><?php echo $text_example_combined ?>:</div>
                ...
                <br>
                <div class="help"><?php echo $text_example_three_columns ?>:</div>
          ...
          <tr>
            <td>
                <?php echo $entry_show_button_back ?>:
            </td>
            <td>
          ...
          <tr>
            <td>
                <?php echo $entry_geoip_mode ?>:
            </td>
            <td>
                <select name="simple_geoip_mode" id="simple_geoip_mode">
                    <option value="1" <?php echo $simple_geoip_mode == 1 ? 'selected="selected"' : '' ?>><?php echo $text_geoip_mode_1 ?></option>
                    <option value="2" <?php echo $simple_geoip_mode == 2 ? 'selected="selected"' : '' ?>><?php echo $text_geoip_mode_2 ?></option>
                    <option value="3" <?php echo $simple_geoip_mode == 3 ? 'selected="selected"' : '' ?>><?php echo $text_geoip_mode_3 ?></option>
                </select>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td>
                <?php echo $entry_type_of_links ?>:
            </td>
            <td>
                <label><input type="radio" name="simple_childs_payment_first" value="1" <?php if ($simple_childs_payment_first) { ?>checked="checked"<?php } ?>><?php echo $text_payment_shipping ?></label>
                <label><input type="radio" name="simple_childs_payment_first" value="0" <?php if (!$simple_childs_payment_first) { ?>checked="checked"<?php } ?>><?php echo $text_shipping_payment ?></label>
            </td>
          </tr>
        </table>
        ...
        <table class="form">
          ...
          <tr>
            <td>
                <?php echo $entry_use_geo_selector; ?>
                <span class="help"><?php echo $text_help_geo_selector ?></span>
            </td>
            <td>
                <label><input type="radio" name="simple_customer_use_geo_selector" value="1" <?php if ($simple_customer_use_geo_selector) { ?>checked="checked"<?php } ?>><?php echo $text_yes ?></label>
                <label><input type="radio" name="simple_customer_use_geo_selector" value="0" <?php if (!$simple_customer_use_geo_selector) { ?>checked="checked"<?php } ?>><?php echo $text_no ?></label>
                <?php if (isset($error_simple_customer_use_geo_selector)) { ?>
                <span class="error"><?php echo $error_simple_customer_use_geo_selector ?></span>
                <?php } ?>
            </td>  
          </tr>
          <tr>
            <td>
                <?php echo $entry_geo_selector_type ?>:
            </td>
            <td>
                <select name="simple_customer_geo_selector_type" id="simple_customer_geo_selector_type">
                    <option value="1" <?php echo $simple_customer_geo_selector_type == 1 ? 'selected="selected"' : '' ?>><?php echo $text_geo_selector_type_1 ?></option>
                    <option value="2" <?php echo $simple_customer_geo_selector_type == 2 ? 'selected="selected"' : '' ?>><?php echo $text_geo_selector_type_2 ?></option>
                    <option value="3" <?php echo $simple_customer_geo_selector_type == 3 ? 'selected="selected"' : '' ?>><?php echo $text_geo_selector_type_3 ?></option>
                </select>
            </td>
          </tr>
          <tr>
        ...
        <table class="form">
          <tr>
            ...
            <td>
                <label><input type="radio" name="simple_address_hide_if_logged" value="1" <?php if ($simple_address_hide_if_logged) { ?>checked="checked"<?php } ?>><?php echo $text_yes ?></label>
                <label><input type="radio" name="simple_address_hide_if_logged" value="0" <?php if (!$simple_address_hide_if_logged) { ?>checked="checked"<?php } ?>><?php echo $text_no ?></label>
                <?php if (isset($error_simple_customer_hide_if_logged)) { ?>
                <span class="error"><?php echo $error_simple_customer_hide_if_logged ?></span>
                <?php } ?>
            </td>  
          ...
          <tr>
            ...
            <td>
                <label><input type="radio" name="simple_shipping_address_use_geo_selector" value="1" <?php if ($simple_shipping_address_use_geo_selector) { ?>checked="checked"<?php } ?>><?php echo $text_yes ?></label>
                <label><input type="radio" name="simple_shipping_address_use_geo_selector" value="0" <?php if (!$simple_shipping_address_use_geo_selector) { ?>checked="checked"<?php } ?>><?php echo $text_no ?></label>
                <?php if (isset($error_simple_shipping_address_use_geo_selector)) { ?>
                <span class="error"><?php echo $error_simple_shipping_address_use_geo_selector ?></span>
                <?php } ?>
            </td>  
          </tr>
          <tr>
            ...
            <td>
                <select name="simple_shipping_address_geo_selector_type" id="simple_shipping_address_geo_selector_type">
                    <option value="1" <?php echo $simple_shipping_address_geo_selector_type == 1 ? 'selected="selected"' : '' ?>><?php echo $text_geo_selector_type_1 ?></option>
                    <option value="2" <?php echo $simple_shipping_address_geo_selector_type == 2 ? 'selected="selected"' : '' ?>><?php echo $text_geo_selector_type_2 ?></option>
                    <option value="3" <?php echo $simple_shipping_address_geo_selector_type == 3 ? 'selected="selected"' : '' ?>><?php echo $text_geo_selector_type_3 ?></option>
                </select>
            </td>
          </tr>
          <?php foreach($groups as $group) { ?>
            ...
            <tbody>
              ...
              <tr>
                <td style="padding:5px;">
                    ...
                    <span class="help"><?php echo $text_example ?> citylink.citylink1</span>
                </td>
                <td style="padding:5px;">
                    <a onclick="add_shipping_method_for_customer('<?php echo str_replace("'", "\\'",$group['customer_group_id']) ?>')" class="button"><span><?php echo $button_add; ?></span></a>
                </td>  
              </tr>
            </tbody>
          </table>
        ...
        <table class="list">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="padding:5px;">
                    <a onclick="add_shipping_method_for_shipping('<?php echo str_replace("'", "\\'",$group['customer_group_id']) ?>')" class="button"><span><?php echo $button_add; ?></span></a>
                </td>  
              </tr>
            </tbody>
          </table>
          ...
          <table class="list">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="padding:5px;">
                    <?php echo selectbox_html('simple_links['.$payment_code.']', isset($simple_links[$payment_code]) ? $simple_links[$payment_code] : "", $shipping_extensions, 'text', $text_example_for_links) ?>
                </td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
        <h3><?php echo $text_module_links_2 ?></h3>
          <table class="list">
            <thead>
              <tr>
                <td class="left"><?php echo $entry_shipping_module; ?></td>
                <td class="left"><?php echo $entry_payment_modules; ?></td>
              </tr>
            </thead>
            <tbody>
              <?php foreach ($shipping_extensions_2 as $shipping_code => $shipping_name) { ?>
              <tr>
              ...
              <?php } ?>
              <tr>
                <td style="width:20%;padding:5px"><input type="text" value="" id="simple_links_2_stub"><span class="help"><?php echo $text_example_for_links ?></span></td>
                <td style="padding:5px;">
                    <?php echo selectbox_html('simple_links_2[simple_links_2_stub]', "", $payment_extensions, 'hidden', '') ?>
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div id="tab-customer-fields">
        ...
        <table class="form" style="margin-bottom:50px;">
          ...
          <!--<tr>
            <td>
                ...
                <span class="help"><?php echo $text_help_move_field ?></span>
            </td>
            <td>
          ...
          <tr class="row_init">
            ...
            <td id="init">
                <?php if ($field['type'] == 'select' && $field['values'] == 'countries') { ?>
                    <select id="country_id" name="simple_fields_main[<?php echo $field['id'] ?>][init]" onchange="$('#zone_id').load('<?php echo str_replace("'", "\\'",$zone_action) ?>&country_id=' + this.value);">
                        <option value="0"><?php echo $text_select ?></option>
          ...
          <tr class="row_date" <?php if ($field['type'] != 'date') { ?>style="display:none;"<?php } ?>>
            ...
            <td id="date">
                <?php echo $entry_min_date ?>: <input name="simple_fields_main[<?php echo $field['id'] ?>][date_min]" type="text" class="datepicker" value="<?php echo !empty($field['date_min']) ? $field['date_min'] : '' ?>" > <?php echo $entry_start_date ?>: <input name="simple_fields_main[<?php echo $field['id'] ?>][date_start]" type="text" size="1" value="<?php echo isset($field['date_start']) ? $field['date_start'] : '' ?>" ><br>
                <?php echo $entry_max_date ?>: <input name="simple_fields_main[<?php echo $field['id'] ?>][date_max]" type="text" class="datepicker" value="<?php echo !empty($field['date_max']) ? $field['date_max'] : '' ?>" > <?php echo $entry_end_date ?>: <input name="simple_fields_main[<?php echo $field['id'] ?>][date_end]" type="text" size="1" value="<?php echo isset($field['date_end']) ? $field['date_end'] : '' ?>" ><br>
                <?php echo $entry_only_business_days ?>: <input name="simple_fields_main[<?php echo $field['id'] ?>][date_only_business]" type="checkbox" value="1" <?php echo !empty($field['date_only_business']) ? 'checked="checked"' : '' ?>>
                <?php echo $entry_only_for_days ?>: <input name="simple_fields_main[<?php echo $field['id'] ?>][date_only_for]" type="input" value="<?php echo !empty($field['date_only_for']) ? $field['date_only_for'] : '' ?>" placeholder="example: 0,1,2,3,4,5,6">
            </td>  
          </tr>
          <tr>
            <td>
        ...
        <table id="<?php echo $field['id'] ?>" class="form" style="margin-bottom:50px;">
          ...
          <tr class="row_date" <?php if ($field['type'] != 'date') { ?>style="display:none;"<?php } ?>>
            ...
            <td id="date">
                <?php echo $entry_min_date ?>: <input name="simple_fields_custom[<?php echo $field['id'] ?>][date_min]" type="text" class="datepicker" value="<?php echo !empty($field['date_min']) ? $field['date_min'] : '' ?>" > <?php echo $entry_start_date ?>: <input name="simple_fields_custom[<?php echo $field['id'] ?>][date_start]" type="text" size="1" value="<?php echo isset($field['date_start']) ? $field['date_start'] : '' ?>" ><br>
                <?php echo $entry_max_date ?>: <input name="simple_fields_custom[<?php echo $field['id'] ?>][date_max]" type="text" class="datepicker" value="<?php echo !empty($field['date_max']) ? $field['date_max'] : '' ?>" > <?php echo $entry_end_date ?>: <input name="simple_fields_custom[<?php echo $field['id'] ?>][date_end]" type="text" size="1" value="<?php echo isset($field['date_end']) ? $field['date_end'] : '' ?>" ><br>
                <?php echo $entry_only_business_days ?>: <input name="simple_fields_custom[<?php echo $field['id'] ?>][date_only_business]" type="checkbox" value="1" <?php echo !empty($field['date_only_business']) ? 'checked="checked"' : '' ?>>
                <?php echo $entry_only_for_days ?>: <input name="simple_fields_custom[<?php echo $field['id'] ?>][date_only_for]" type="input" value="<?php echo !empty($field['date_only_for']) ? $field['date_only_for'] : '' ?>" placeholder="example: 0,1,2,3,4,5,6">
            </td>  
          </tr>
          <tr>
            <td>
        ...
        <table id="custom_new_field" class="form" style="margin-bottom:50px;">
          ...
          <tr class="row_date" style="display:none;">
            ...
            <td id="date">
                <?php echo $entry_min_date ?>: <input name="date_min" type="text" class="datepicker" value="" > <?php echo $entry_start_date ?>: <input name="date_start" type="text" size="1" value="" ><br>
                <?php echo $entry_max_date ?>: <input name="date_max" type="text" class="datepicker" value="" > <?php echo $entry_end_date ?>: <input name="date_end" type="text" size="1" value="" ><br>
                <?php echo $entry_only_business_days ?>: <input name="date_only_business" type="checkbox" value="1" >
                <?php echo $entry_only_for_days ?>: <input name="date_only_for" type="input" value="" placeholder="example: 0,1,2,3,4,5,6"> 
            </td>  
          </tr>
    ...
    <div id="tab-headers">
        ...
        <table class="form">
          <tr>
            <td>
                <b><?php echo $entry_tag_for_headers ?></b>
            </td>
            <td>
    ...
    <div id="tab-methods">
        ...
        <table class="form" style="margin-bottom:10px;">
          <tr>
            ...
            <td>
                <label style="display:block;margin-bottom:0px;"><input type="radio" name="simple_payment_titles[<?php echo $payment_code; ?>][show]" value="0" <?php echo empty($simple_payment_titles[$payment_code]['show']) ? 'checked="checked"' : '' ?>>&nbsp;<?php echo $entry_stub_not_show ?></label>
                <label style="display:block;margin-bottom:0px;"><input type="radio" name="simple_payment_titles[<?php echo $payment_code; ?>][show]" value="1" <?php echo !empty($simple_payment_titles[$payment_code]['show']) && $simple_payment_titles[$payment_code]['show'] == 1 ? 'checked="checked"' : '' ?>>&nbsp;<?php echo $entry_stub_show_always ?></label>
                <label style="display:block;margin-bottom:0px;"><input type="radio" name="simple_payment_titles[<?php echo $payment_code; ?>][show]" value="2" <?php echo !empty($simple_payment_titles[$payment_code]['show']) && $simple_payment_titles[$payment_code]['show'] == 2 ? 'checked="checked"' : '' ?>>&nbsp;<?php echo $entry_stub_show_only_for_empty ?></label>
                <label style="display:block;margin-bottom:5px;"><input type="checkbox" name="simple_payment_titles[<?php echo $payment_code; ?>][use_description]" value="1" <?php echo !empty($simple_payment_titles[$payment_code]['use_description']) ? 'checked="checked"' : '' ?>>&nbsp;<?php echo $entry_stub_use_description ?></label>
                <?php foreach ($languages as $language) { ?>
        ...
        <table class="form" style="margin-bottom:10px;">
          <tr>
            ...
            <td>
                <label style="display:block;margin-bottom:0px;"><input type="radio" name="simple_shipping_titles[<?php echo $shipping_code; ?>][show]" value="0" <?php echo empty($simple_shipping_titles[$shipping_code]['show']) ? 'checked="checked"' : '' ?>>&nbsp;<?php echo $entry_stub_not_show ?></label>
                <label style="display:block;margin-bottom:0px;"><input type="radio" name="simple_shipping_titles[<?php echo $shipping_code; ?>][show]" value="1" <?php echo !empty($simple_shipping_titles[$shipping_code]['show']) && $simple_shipping_titles[$shipping_code]['show'] == 1 ? 'checked="checked"' : '' ?>>&nbsp;<?php echo $entry_stub_show_always ?></label>
                <label style="display:block;margin-bottom:0px;"><input type="radio" name="simple_shipping_titles[<?php echo $shipping_code; ?>][show]" value="2" <?php echo !empty($simple_shipping_titles[$shipping_code]['show']) && $simple_shipping_titles[$shipping_code]['show'] == 2 ? 'checked="checked"' : '' ?>>&nbsp;<?php echo $entry_stub_show_only_for_empty ?></label>
                <label style="display:block;margin-bottom:5px;"><input type="checkbox" name="simple_shipping_titles[<?php echo $shipping_code; ?>][use_description]" value="1" <?php echo !empty($simple_shipping_titles[$shipping_code]['use_description']) ? 'checked="checked"' : '' ?>>&nbsp;<?php echo $entry_stub_use_description ?></label>
                <?php foreach ($languages as $language) { ?>
    ...
    <div id="tab-template">
        <table class="form">
          <tr>
            <td>
                <h4>1) <?php echo $text_template_1 ?><?php echo $theme_folder ?></h4>
            </td>
          </tr>
          <tr>
            <td>
                <h4>2) <?php echo $text_template_2 ?> <?php echo $common_header_path ?></h4>
          ...
          <tr>
            <td>
                <h4>3) <?php echo $text_template_3 ?> <?php echo $common_footer_path ?></h4>
          ...
          <tr>
            <td>
                <h4>4) <?php echo $text_template_4 ?> <?php echo $styles_path ?></h4>
            </td>
          </tr>
        </table>
    </div>
...
function add_field(form_selector, msc_selector, fields_name, field_prefix) {
    ...
    var date_only_for = $(form_selector + ' input[name=\'date_only_for\']').val();
    if (type == 'select') {
        init_html += '</select>';
    }
    ...
    $(msc_selector).append('<table id="'+id+'" class="form" style="margin-bottom:50px;">' +
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'", $entry_field_id); ?>' +
            '</td>' +
            '<td>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_label); ?>' +
            '</td>' +
            '<td>' +
                '<?php foreach ($languages as $language) { ?>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_object); ?>' +
            '</td>' +
            '<td>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_object_field); ?>' +
            '</td>' +
            '<td>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_type); ?>' +
            '</td>' +
            '<td>' +
          ...
          '<tr class="row_date" '+((type != 'date') ? 'style="display:none;"' : '')+'>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_init); ?>' +
            '</td>' +
            '<td id="date">' +
                '<?php echo str_replace("'", "\\'",$entry_min_date) ?>: <input name="'+fields_name+'['+id+'][date_min]" type="text" class="datepicker" value="'+date_min+'" > <?php echo $entry_start_date ?>: <input name="'+fields_name+'['+id+'][date_start]" type="text" size="1" value="'+date_start+'" ><br>' +
                '<?php echo str_replace("'", "\\'",$entry_max_date) ?>: <input name="'+fields_name+'['+id+'][date_max]" type="text" class="datepicker" value="'+date_max+'" > <?php echo $entry_end_date ?>: <input name="'+fields_name+'['+id+'][date_end]" type="text" size="1" value="'+date_end+'" ><br>' +
                '<?php echo str_replace("'", "\\'",$entry_only_business_days) ?>: <input name="'+fields_name+'['+id+'][date_only_business]" type="checkbox" value="1" ' + (date_only_business ? 'checked="checked"' : '') + '>' +
                '<?php echo str_replace("'", "\\'",$entry_only_for_days) ?>: <input name="'+fields_name+'['+id+'][date_only_for]" type="input" value="' + date_only_for + '">' +
            '</td>  ' +
          '</tr>' +
          '<tr class="row_values" '+((type == 'text' || type == 'textarea' || type == 'select_from_api' || type == 'radio_from_api' || type == 'checkbox_from_api' || type == 'date') ? 'style="display:none;"' : '')+'>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_values); ?>' +
            '</td>' +
            '<td>' +
                '<?php foreach ($languages as $language) { ?>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_validation); ?>' +
            '</td>' +
            '<td>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_validation_error); ?>' +
            '</td>' +
            '<td>' +
                '<?php foreach ($languages as $language) { ?>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_field_save_to); ?>' +
            '</td>' +
            '<td>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_jquery_masked_input_mask); ?>' +
            '</td>' +
            '<td>' +
          ...
          '<tr>' +
            '<td>' +
                '<?php echo str_replace("'", "\\'",$entry_placeholder); ?>' +
            '</td>' +
            '<td>' +
                '<?php foreach ($languages as $language) { ?>' +
...
function add_shipping_method_for_customer(customer_group_id) {
    ...
    if (part2) {
        ...
        var html = '<tr>' +
            ...
            '<option value="<?php echo $key ?>"><?php echo str_replace('\'', '"',$text) ?></option>' +
            <?php } ?>
            '</select>' +
            '<br><a style="margin-top:5px" onclick="$(this).parent().parent().remove()" class="button"><span><?php echo $button_delete; ?></span></a>' +
            '</td>' +
...
$(function() {
    ...
    $('#simple_links_2_stub').keyup(function(){
        $(this).parents('td').next().find('input').attr('name', 'simple_links_2['+$(this).val()+']');
    });
});
</script>
<?php echo $footer; ?>