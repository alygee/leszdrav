<?php echo $header; ?><?php if( ! empty( $mfilter_json ) ) { echo '<div id="mfilter-json" style="display:none">' . $mfilter_json . '</div>'; } ?>
...
<?php echo $column_left; ?><?php echo $column_right; ?>
    <div id="content"><h1 class="heading-title"><?php echo $heading_title; ?></h1><?php echo $content_top; ?><div id="mfilter-content-container">
      ...
      <?php if ($product['thumb']) { ?>
        <div class="image">
            <a href="<?php echo $product['href']; ?>" <?php if(isset($product['thumb2']) && $product['thumb2']): ?> class="has-second-image" style="background: url('<?php echo $product['thumb2']; ?>') no-repeat;" <?php endif; ?>>
                <img class="lazy first-image" width="<?php echo $this->journal2->settings->get('config_image_width'); ?>" height="<?php echo $this->journal2->settings->get('config_image_height'); ?>" src="<?php echo $this->journal2->settings->get('product_dummy_image'); ?>" data-src="<?php echo $product['thumb']; ?>" title="<?php echo $product['img_title']; ?>" alt="<?php echo $product['img_alt']; ?>" />
            </a>
      ...
      <?php } else { ?>
        <div class="image">
            <a href="<?php echo $product['href']; ?>">
                <img class="first-image" width="<?php echo $this->journal2->settings->get('config_image_width'); ?>" height="<?php echo $this->journal2->settings->get('config_image_height'); ?>" src="<?php echo $this->journal2->settings->get('product_no_image'); ?>" title="<?php echo $product['img_title']; ?>" alt="<?php echo $product['img_alt']; ?>" />
            </a>
            <?php if (isset($product['labels']) && is_array($product['labels'])): ?>
            <?php foreach ($product['labels'] as $label => $name): ?>
            <?php if ($label === 'outofstock'): ?>
...
function display(view) {
	if (view == 'list') {
		...
		$('.main-products.product-list > div').each(function(index, element) {
            ...
            html += '  <div class="name b1c-name">' + $(element).find('.name').html() + '</div>';
            ...
            html += '<div class="but b1c">Быстрый заказ';
            html += '</div>';
...
html += '<div class="but b1c">Быстрый заказ';
            ...
            $(element).html('<div class="product-wrapper b1c-good">'+html+'</div>');
		});
