...
<?php echo $content_top; ?>
  <div class="product-info <?php echo $this->journal2->settings->get('split_ratio'); ?> b1c-good" data-respond="start: 620px; end: 630px; interval: 10px;">
    ...
    <h1 class="heading-title b1c-name" itemprop="name"><?php echo $heading_title; ?></h1>
    <?php endif; ?>

<div class="description" style="font-family: Georgia, serif;font-style: italic;color:#333;font-size: 14px;"><?php echo $description; ?></div>
    ...
    <?php endforeach; ?>
      <!--<div class="description">
        ...
        <span class="brand-logo">
            ...
            <a href="<?php echo $manufacturers; ?>" class="brand-logo-text">Бренд:<br/>
                <b><?php echo $manufacturer_image_name; ?></b>
            </a>
            <?php endif; ?>
        </span>
        <?php else: ?>
    ...
    <table class="attribute">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="border-right:none !important;"><?php echo $attribute['text']; ?></td>
        </tr>
        <?php } ?>
      </tbody>
      <?php } ?>
...
<div class="product b1c">Быстрый заказ</div>
...
#tab-review input[type='text']{height:25px;}
...
#tab-review .entry-b{display:block;float:left;width:150px;padding:0px 0 53px 0;}
